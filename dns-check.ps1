...
Write-Host "DNS Configuration for DigitalOcean" -ForegroundColor Cyan
Write-Host "Domain: oakdragoncovenant.com" -ForegroundColor Green
Write-Host "New IP: 137.184.77.5" -ForegroundColor Green
Write-Host "=====================================" -ForegroundColor Cyan

Write-Host ""
Write-Host "DNS Records to Update in IONOS:" -ForegroundColor Yellow
Write-Host ""
...
Write-Host ""
Write-Host "After updating DNS, test with:" -ForegroundColor Yellow
